...
<div class="container">
        <div class="workout-details">
           ...
           if ($prepareStmt) {
            ...
            // Display the user's workout details
            // echo "<div class='container'>";
            // echo "<div class='workout-details'>";
            // echo "<h2>User Workout Details</h2>";
            // echo "<p>Workout Date: " . $user["workout_date"] . "</p>";
            // echo "<p>Workout Type: " . $user["workout_type"] . "</p>";
            // echo "<p>Duration: " . $user["duration"] . "</p>";
            // echo "<p>Calories: " . $user["calories_burnt"] . "</p>";
            // echo "<p>Distance: " . $user["distance"] . "</p>";
            // echo "</div>";
            // echo "</div>";
        ?>
